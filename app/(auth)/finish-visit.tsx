...
export default function FinishVisit() {
    ...
    const visitId = "1" // normally comes from checkin API
    ...
    const finishVisit = async () => {
        ...
        try {
            ...
            await fetch(
                `${BASE_URL}/server/rp/visits/${visitId}/checkout`,
                {
                    method: "PATCH",
                    headers: {
                    ...
                    body: JSON.stringify({
                        checkout_lat: 21.1458,
                        checkout_lng: 79.0882
                    })
                }
            )
...
mapCard:{backgroundColor:"#fff",margin:20,borderRadius:14,overflow:"hidden"},
mapHeader:{flexDirection:"row",alignItems:"center",padding:15},
mapTitle:{marginLeft:8,fontWeight:"600"},
mapImage:{width:"100%",height:180},
summaryCard:{backgroundColor:"#fff",marginHorizontal:20,padding:16,borderRadius:14},
summaryTitle:{fontWeight:"700",fontSize:16,marginBottom:10},
row:{flexDirection:"row",justifyContent:"space-between",marginBottom:10},
label:{color:"#6B7280"},
value:{fontWeight:"600"},
duration:{fontWeight:"700",color:"#F97316"},
successCard:{flexDirection:"row",alignItems:"center",backgroundColor:"#DCFCE7",marginHorizontal:20,padding:14,borderRadius:12,marginTop:10},
successText:{marginLeft:8,color:"#16A34A",fontWeight:"600"},
submitBtn:{backgroundColor:"#F97316",margin:20,padding:16,borderRadius:14,alignItems:"center"},
submitText:{color:"#fff",fontWeight:"700",fontSize:16},
cancelText:{textAlign:"center",color:"#6B7280"},
modalOverlay:{flex:1,backgroundColor:"rgba(0,0,0,0.4)",justifyContent:"center",alignItems:"center"},
modalCard:{backgroundColor:"#fff",padding:30,borderRadius:20,alignItems:"center",width:"80%"},
modalTitle:{fontSize:18,fontWeight:"700",marginTop:10},
modalSub:{color:"#6B7280",marginTop:5,textAlign:"center"},
modalBtn:{backgroundColor:"#F97316",padding:12,borderRadius:10,marginTop:20,width:"100%",alignItems:"center"},
